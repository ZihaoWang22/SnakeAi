...
from snake_game_circle import SnakeGame
...
class SnakeEnv(gym.Env):
    ...
    def step(self, action):
        ...
        if self.reward_step_counter > info["snake_size"] * 15:  ##假如循环长度大于当前长度的10倍则给与一定的惩罚
        ...
        if self.done: # Snake bumps into wall or itself. Episode is over.
            ...
            reward = 0.1 * info["snake_size"] / self.grid_size
            ...
            # only work in short size
            if info["snake_size"] < self.grid_size/3:
