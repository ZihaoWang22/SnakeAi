...
class SnakeGame:
    def __init__(self, seed=0, board_size=12, silent_mode=True):
        ...
        if not silent_mode:
            ...
            # mixer.music.load("./sound/jj.mp3") 
            # mixer.music.load("./sound/Trump.mp3") 
    ...
    def draw_snake(self):
        ...
        # Draw the head (Blue)
        pygame.draw.polygon(self.screen, (0, color_list[1], 0), [
        ...
        for r, c in self.snake[1:]:
            ...
            pygame.draw.rect(self.screen, (0, color_list[1], 0),
