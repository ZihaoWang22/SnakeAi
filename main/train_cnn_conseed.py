...
def main():
    ...
    env = SubprocVecEnv([make_env(seed=20230525) for s in seed_set])
    ...
    MODEL_PATH = r"trained_models_cnn_constant_seed/ppo_snake_70875000_steps"
    model = MaskablePPO.load(MODEL_PATH, env, n_steps=2048,
        batch_size=512,
        n_epochs=4,
        gamma=0.94,
        learning_rate=lr_schedule,
    ...
    # Writing the training logs from stdout to a 
